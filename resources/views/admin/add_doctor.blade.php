        ...
        <div class="wrap shadow">
            ...
            <div  class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h2 class="text-center text-primary mb-3" style="font-wight:600;font-size:30px">Add New Doctor</h2><span class="w-100 mb-5"style="border:2px solid white;float:left"></span>
                    <form action="{{url('uploaddoctor')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Doctor Name</label>
                            <input style="background-color:black;color:white" name="name" class="form-control" type="text" required>
                        </div>
                        <div class="form-group">
                            <label for="">Phone</label>
                            <input style="background-color:black;color:white" name="phone" class="form-control" type="integer" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input style="background-color:black;color:white" name="room" class="form-control" type="text" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="mt-2"for="">Doctor Image:</label>
